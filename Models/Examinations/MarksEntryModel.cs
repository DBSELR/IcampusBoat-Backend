...
namespace IcampusBoatBackend.Models.Examinations
{
    ...
    public class MidTypeFilterModel
    {
        public string? AcademicYear { get; set; }
        public string? Programme { get; set; }
        public string? Branch { get; set; }
    ...
    public class MaxMinMarksFilterModel
    {
        public string? AcademicYear { get; set; }
        public string? Programme { get; set; }
        public string? Branch { get; set; }
    ...
    public class InternalDateFilterModel
    {
        public string? Programme { get; set; }
        public string? Year { get; set; }
        public string? Semester { get; set; }
    ...
    public class StudentMarksFilterModel
    {
        public string? AcademicYear { get; set; }
        public string? Programme { get; set; }
        public string? Branch { get; set; }
    ...
    public class ValidateRegNoFilterModel
    {
    ...
    public class MarksEntrySaveModel
    {
    ...
    public class MarksEntryAttendanceSaveModel
    {
        public string? AcademicYear { get; set; }
        public string? Programme { get; set; }
        public string? Branch { get; set; }
